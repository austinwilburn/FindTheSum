...
public class FindTheSumTester {
	...
	/*
	 * Test the arrayToString method in FindTheSum
	 */
	...
	private static void horizontalSumsTest(){
		...
		arrayAsString = FindTheSum.arrayToString(array1);
		System.out.println(arrayAsString);
		System.out.println("horizontalSums(array1, 7):");
		horizontalSums = FindTheSum.horizontalSums(array1, 7);
		arrayAsString = FindTheSum.arrayToString(horizontalSums);
		System.out.println(arrayAsString);
		System.out.println("array2:");
		arrayAsString = FindTheSum.arrayToString(array2);
		System.out.println(arrayAsString);
		System.out.println("horizontalSums(array2, 20):");
		horizontalSums = FindTheSum.horizontalSums(array2, 20);
		arrayAsString = FindTheSum.arrayToString(horizontalSums);
		System.out.println(arrayAsString);
		System.out.println("horizontalSums(array2, 25):");
		horizontalSums = FindTheSum.horizontalSums(array2, 25);
		arrayAsString = FindTheSum.arrayToString(horizontalSums);
		System.out.println(arrayAsString);
		System.out.println();
	}
	...
	private static void verticalSumsTest(){
		...
		verticalSums = FindTheSum.verticalSums(array1, 22);
		arrayAsString = FindTheSum.arrayToString(verticalSums);
		System.out.println(arrayAsString);
		System.out.println("array2:");
		arrayAsString = FindTheSum.arrayToString(array2);
		System.out.println(arrayAsString);
		System.out.println("verticalSums(array2, 14):");
		verticalSums = FindTheSum.verticalSums(array2, 14);
		arrayAsString = FindTheSum.arrayToString(verticalSums);
		System.out.println(arrayAsString);
		System.out.println("verticalSums(array2, 33):");
		verticalSums = FindTheSum.verticalSums(array2, 33);
		arrayAsString = FindTheSum.arrayToString(verticalSums);
		System.out.println(arrayAsString);
		System.out.println();
	}
